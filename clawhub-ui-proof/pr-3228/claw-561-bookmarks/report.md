...
- Mobile: actual browser viewport `391x844`, Lucide `bookmark`, accessible name `Bookmark skill`
- Browser actions remained signed out; no Test or production writes occurred.
